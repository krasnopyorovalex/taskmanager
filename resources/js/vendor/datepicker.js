const DatePicker = (function () {
    ...
    function DatePicker() {
        ...
        _self.showPicker = function () {
            ...
            if (pickerField && pickerDiv) {
                pickerDiv.style.position = 'absolute';
                pickerDiv.style.left = '0';
        ...
        _self.handleDocumentClick = function (event) {
            ...
            if (et !== pickerField && et !== pickerDiv && ! et.classList.contains('is-edited') && et.tagName !== 'svg' && et.tagName !== 'use' && et.tagName !== 'SPAN') {
                _self.hidePicker();
            }
        };
